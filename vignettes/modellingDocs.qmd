...
We assessed the sensitivity of model results to the choice of prior distributions by fitting the model under a set of predefined prior scenarios. Each scenario specified a different set of prior settings for the model parameters, while keeping the predictor variables, spatial prior, datasets, spatial mesh, study-area boundary, coordinate reference system, and bias formulation constant. This allowed us to evaluate whether model fit was sensitive to the assumptions made about the prior distributions
